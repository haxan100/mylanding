...
<section class="content">
	<a href="javascript:void(0)" data-toggle="modal" data-target="#modal-detail" class="btn m-t-18 btn-info waves-effect waves-light btnTambah">
		<i class="ti-plus"></i> Tambah Porto Baru
	</a>
	<br>
								...
								<div class="x_panel">
									...
									<div class="x_content">
										...
										<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
											<div class="row">
												<input id="id" name="id" class="form-control " readonly type="hidden" class="form-control">
											...
											<div class="row">
												<div class="item form-group col-md-6 col-sm-6 ">
													...
													<div class="">
														<input id="kategori" name="kategori" class="form-control " placeholder="Isikan Kategori" type="text" class="form-control">
												...
												<div class="item form-group col-md-6 col-sm-6 ">
													...
													<div class="">
														<input id="link" name="link" class="form-control " placeholder="Isikan Link" type="text" class="form-control">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="item form-group col-md-6 col-sm-6 ">
													<label class="col-form-label label-align" for="last-name">Gambar <span class="required">*</span>
													</label>
													<div class="">
...
<script>
	$(document).ready(function() {
		...
		var url_form_tambah = bu + 'admin/tambah_porto_proses';
		var url_form_ubah = bu + 'admin/ubah_porto_proses';
